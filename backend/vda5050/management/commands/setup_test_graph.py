...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for node_data in nodes_data:
            ...
            self.stdout.write(f'  ✅ Created node: {node_data["node_id"]} at ({node_data["x"]}, {node_data["y"]})')
        ...
        self.stdout.write(f'  Avg connections per node: {GraphEdge.objects.count() / GraphNode.objects.count():.1f}')
