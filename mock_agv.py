...
def on_message(client, userdata, msg):
    ...
    try:
        ...
        if "nodes" in payload:
            ...
            print(f"   -> Start driving... Path: {len(current_state['nodes_to_visit'])} nodes")
...
def simulate_loop():
    ...
    while True:
        # 1. LOGIC DI CHUYỂN
        if current_state["driving"] and current_state["nodes_to_visit"] and not current_state.get("paused", False):
            ...
            print(f"🚚 Arrived at {current_state['lastNodeId']} ({current_state['x']}, {current_state['y']})")
        ...
        payload = {
            ...
            "batteryState": {"batteryCharge": current_state["battery"], "charging": not current_state["driving"]},
            "agvPosition": {"x": current_state["x"], "y": current_state["y"], "mapId": "map_1"},
            "errors": []
        }
